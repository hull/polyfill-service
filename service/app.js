...
var createMiddleware = function(options){
  var proxy = corsProxy.createProxy(options);
  return corsProxy.getHandler(options, proxy);
}

var requestMiddleware = createMiddleware({
...
app.get("/cors/*", function(req, res, next){
  ...
  return requestMiddleware(req,res);
});
